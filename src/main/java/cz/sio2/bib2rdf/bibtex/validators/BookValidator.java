...
public class BookValidator {
    ...
    public static void validate(final EntityManager em, final String id)
        ...
        ValidationUtils.checkNonEmpty(Vocabulary.s_p_hasPublisher, a.getHasPublisher(), warnings);
        ValidationUtils.checkNonEmpty(Vocabulary.s_p_humanCreator, a.getHumanCreator(), warnings);
