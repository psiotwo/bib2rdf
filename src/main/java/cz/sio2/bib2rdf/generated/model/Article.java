 ...
 */
@OWLClass(iri = Vocabulary.s_c_Article) public class Article extends Entry {
    ...
    @OWLDataProperty(iri = Vocabulary.s_p_hasJournal) @ParticipationConstraints(
        {@ParticipationConstraint(
            owlObjectIRI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#PlainLiteral", min = 1)})
    protected Set<String> hasJournal;
    ...
    public Set<String> getHasJournal() {
        return hasJournal;
    }

    public void setHasJournal(Set<String> hasJournal) {
