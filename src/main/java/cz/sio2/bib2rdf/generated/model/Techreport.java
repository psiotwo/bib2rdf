 ...
 */
@OWLClass(iri = Vocabulary.s_c_Techreport) public class Techreport extends Entry {
    ...
    @OWLDataProperty(iri = Vocabulary.s_p_hasInstitution) @ParticipationConstraints(
        {@ParticipationConstraint(
            owlObjectIRI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#PlainLiteral", min = 1)})
    protected Set<String> hasInstitution;
    ...
    public Set<String> getHasInstitution() {
        return hasInstitution;
    }

    public void setHasInstitution(Set<String> hasInstitution) {
