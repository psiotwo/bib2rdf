 ...
 */
@OWLClass(iri = Vocabulary.s_c_Unpublished) public class Unpublished extends Entry {
    ...
    @OWLDataProperty(iri = Vocabulary.s_p_hasNote) @ParticipationConstraints(
        {@ParticipationConstraint(owlObjectIRI = "http://www.w3.org/2001/XMLSchema#string",
                                  min = 1)}) protected Set<String> hasNote;
    ...
    public Set<String> getHasNote() {
        return hasNote;
    }

    public void setHasNote(Set<String> hasNote) {
